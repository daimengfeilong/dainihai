	...
	$.extend(Plugin.prototype, {
		...
		tooltip: function() {
			if (!this.tipso_bubble) {
				this.tipso_bubble = $(
					"<div class='tipso_bubble'><div class='tipso_content'><div class='tipso_title'></div><div  class='tipso_contents'></div></div><div class='tipso_arrow'></div></div>"
				);
			}
		...
		show: function() {
			...
			tipso_bubble.find('.tipso_title').html(obj.ctitle());
			tipso_bubble.find('.tipso_contents').html(obj.content());
			reposition(obj);
			$win.resize(function() {
				reposition(obj);
			});
		...
		ctitle: function() {
			...
			} else if (obj.settings.ctitle) {
				ctitle = obj.settings.ctitle;
			} else {
				if (obj.settings.useTitle === true) {
					ctitle = title;
				} else {
					ctitle = $e.data('tipso-title');
				}
			}
			return ctitle;
		},
