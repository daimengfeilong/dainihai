...
var supports = function() {
		...
		var a, b, c, d = document.createElement("div").style,
			e = ["", "Moz", "Webkit", "Khtml", "O", "ms"];
		return function(f) {
			if ("string" == typeof d[f]) return !0;
			for (f = f.replace(/^[a-z]/, function(a) {
					return a.toUpperCase()
				}), b = 0, c = e.length; c > b; b += 1)
				if (a = e[b] + f, "string" == typeof d[a]) return !0;
			return !1
		}
	}(),
	Slider = function(a) {
		"use strict"; /*global jQuery, setTimeout, clearTimeout*/
		var b = {
			npos: 0,
			timer: null,
			config: function(a) {
				b.target = a.target, b.container = b.target.find(".slider-wrapper"), b.sWidth = b.container.find(".page_slide").outerWidth(!0), b.max = b.container.find(".page_slide").length, b.tWidth = b.sWidth * b.max, b.time = a.time || 5e3
			},
			early: function() {
				var b, c, d = this,
					e = d.target;
				for (d.container.css({
						width: d.tWidth
					}), e.append(d.pager()), b = 0, c = d.max; c > b; b += 1) d.items(b + 1).insertBefore(a(".slider-nav .next").parents("li"));
